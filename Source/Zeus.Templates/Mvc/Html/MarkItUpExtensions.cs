...
namespace Zeus.Templates.Mvc.Html
{
	public static class MarkItUpExtensions
	{
		...
		public static string MarkItUpTextArea(this HtmlHelper htmlHelper, string name)
		{
			var result = new StringBuilder();
			result.Append("<div class=\"markItUpTextArea\">" + htmlHelper.TextArea(name) + "</div>");
			result.Append("<div class=\"markItUpPreviewContainer\"><div class=\"" + name + "Preview\"></div></div>");
