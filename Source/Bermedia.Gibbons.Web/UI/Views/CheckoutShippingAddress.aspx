<%@ Page Title="" Language="C#" MasterPageFile="~/UI/MasterPages/Default.Master" AutoEventWireup="true" CodeBehind="CheckoutShippingAddress.aspx.cs" Inherits="Bermedia.Gibbons.Web.UI.Views.CheckoutShippingAddress" %>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
	<h1>Shipping Address</h1>
	<p>Please select a shipping address from your address book (below) or enter a new shipping address.</p>
	...
	<h2>Address Book</h2>
	<isis:TypedListView runat="server" ID="lsvAddressBook" DataSource='<%$ Code:this.Customer.ShippingAddresses %>' DataItemTypeName="Bermedia.Gibbons.Web.Items.Address, Bermedia.Gibbons.Web">
		<LayoutTemplate>
