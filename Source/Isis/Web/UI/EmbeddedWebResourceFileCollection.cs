...
namespace Isis.Web.UI
{
	...
	public class EmbeddedWebResourceFileCollection : KeyedCollection<string, EmbeddedWebResourceFile>
	{
		/// <summary>
		...
		public EmbeddedWebResourceFileCollection() : base(StringComparer.InvariantCultureIgnoreCase) { }
		...
		/// </param>
		/// <seealso cref="EmbeddedResourceVirtualFileCollection" />
		public EmbeddedWebResourceFileCollection(IEqualityComparer<String> comparer) : base(comparer) { }
		...
		/// </param>
		/// <seealso cref="EmbeddedResourceVirtualFileCollection" />
		public EmbeddedWebResourceFileCollection(IEqualityComparer<String> comparer, int dictionaryCreationThreshold) : base(comparer, dictionaryCreationThreshold) { }
		...
		/// </param>
		/// <seealso cref="EmbeddedResourceVirtualFileCollection" />
		protected override string GetKeyForItem(EmbeddedWebResourceFile item)
		{
