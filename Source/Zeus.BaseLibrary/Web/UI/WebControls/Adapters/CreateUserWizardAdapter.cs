...
namespace Isis.Web.UI.WebControls.Adapters
{
		...
		protected override void CreateChildControls()
		{
			...
			if (wizard != null)
			{
				...
				if (activeStep != null)
				{
					...
					if (activeStep.CustomNavigationTemplate != null && activeStep.Controls.Count == 1)
					{
						Control container = activeStep.CustomNavigationTemplateContainer;
						if (container != null)
						{
							container.Controls.Clear();
							activeStep.CustomNavigationTemplate.InstantiateIn(container);
							container.DataBind();
						}
					...
					if (activeStep != null)
					{
						...
						else if (wizard.CreateUserStep.Equals(activeStep))
						{
							...
							if (activeStep.CustomNavigationTemplate == null)
								...
								activeStep.CustomNavigationTemplateContainer.RenderControl(writer);
						}
