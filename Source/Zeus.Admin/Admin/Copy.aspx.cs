...
[assembly: EmbeddedResourceFile("Zeus.Admin.Copy.aspx", "Zeus.Admin")]
namespace Zeus.Admin
{
	[ActionPlugin("Copy", "Copy", null, "CutCopyPaste", 2, "zeusnav.memorize('{selected}','Copy.aspx');", "Zeus.Admin.Resources.page_copy.png")]
	public partial class Copy : PreviewFrameAdminPage
	{
		...
		{
			Page.ClientScript.RegisterCssResource(typeof(Copy), "Zeus.Admin.Assets.Css.edit.css");
			base.OnPreRender(e);
		}
	}
}
