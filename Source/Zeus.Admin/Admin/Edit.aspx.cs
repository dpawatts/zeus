...
[assembly: EmbeddedResourceFile("Zeus.Admin.Edit.aspx", "Zeus.Admin")]
namespace Zeus.Admin
{
	[ActionPlugin("Edit", "Edit", Operations.Change, "NewEditDelete", 2, null, "Zeus.Admin.Edit.aspx", "selected={selected}", Targets.Preview, "Zeus.Admin.Resources.page_edit.png")]
	[AvailableOperation(Operations.Change, "Change", 30)]
	public partial class Edit : PreviewFrameAdminPage
	{
		...
		{
			Page.ClientScript.RegisterCssResource(typeof(Edit), "Zeus.Admin.Assets.Css.edit.css");
