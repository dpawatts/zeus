...
[assembly: EmbeddedResourceFile("Zeus.Admin.Security.Default.aspx", "Zeus.Admin")]
namespace Zeus.Admin.Security
{
	[ActionPlugin("Permissions", "Permissions", Operations.Administer, "ViewPreview", 3, null, "Zeus.Admin.Security.Default.aspx", "selected={selected}", Targets.Preview, "Zeus.Admin.Resources.lock.png")]
