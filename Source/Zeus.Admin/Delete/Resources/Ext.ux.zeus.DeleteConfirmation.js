						...
						[
							{
								...
								{
									dataUrl: '/admin/Delete/AffectedItems.ashx',
									listeners:
									{
										load:
										{
							...
							},
							{
								...
								loader: new Ext.tree.TreeLoader(
								{
									dataUrl: '/admin/Delete/ReferencingItems.ashx'
								}),
								root:
								{
									nodeType: 'async',
			...
			[
				{
					...
					handler: function()
					{
						stbStatusBar.showBusy();
						win.hide();
						Coolite.AjaxMethods.Delete.DeleteItems(affectedItemIDs, { url: "/admin/default.aspx" });
					}
				},
				{
					text: 'No',
