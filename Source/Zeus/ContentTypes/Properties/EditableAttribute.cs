...
namespace Zeus.ContentTypes.Properties
{
	...
	public class EditableAttribute : AbstractEditorAttribute
	{
		...
		protected virtual void SetEditorValue(Control editor, object value)
		{
			...
			if (pi == null) throw new ZeusException("No property '{0}' found on the editor control '{1}'.", this.ControlPropertyName, editor.GetType());
