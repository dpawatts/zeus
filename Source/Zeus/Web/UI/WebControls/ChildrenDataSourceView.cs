...
{
	public class ChildrenDataSourceView : ContentDataSourceView, IStateManager
	{
		...
		public ChildrenDataSourceView(DataSourceControl owner, string viewName, HttpContext context, ContentItem parentItem)
